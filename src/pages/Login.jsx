        ...
        <div className="fixed w-full px-4 py-24 z-50">
          <div className="max-w-[450px] h-[600px] mx-auto bg-black/75 text-white">
            <div className="max-w-[320px] mx-auto py-16">
              ...
              {error ? (
                <p className="p-1 bg-red-400 my-2 text-center rounded">
              ...
              >
                <input
                  ...
                  className="p-3 my-0 bg-gray-700 rounded"
                  type="email"
                  placeholder="Email"
                />
                <input
                ...
                <p className="py-4 flex gap-x-2 cursor-pointer">
...
// 1:43:06 error al poner contrasena mal
